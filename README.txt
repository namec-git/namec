...
Namec -- name code for programming with arbitrary names
      ...
      Available from:
        <http://qhull.org/download/namec-2018.1-1.0.0.zip> w/ namec.exe
...
Purpose
  ...
  world program is a test of the system.  The traditional hello world is:

     say hello->
     hello world=
  
  Namec executes, compiles, and assembles name code.  The distribution includes
  name code programs for a regular expression recognizer, three Turing machines, 
  a name machine, and various tests.
...
Environment requirements
  ...
  Windows (www.masm32.org) installed in /masm32/.  Review PlatformToolset
  in the *.vcxproj files.  Define environment variable $QTDIR.
  
  Namec is copyrighted software.  Please read COPYRIGHT.txt, LICENSE.txt,
...
To cite Namec, please use
  ...
  http://github.com/namec-git/namec/doc/pseudocode.rtf, 2018.
...
Distributed files
  ...
  doc/pseudocode.rtf   // An introduction to name code with example programs

  src/thid-app.pri      // Include file for Qt projects 
  src/thid-warn.pri     // Include warnings for Qt projects

  src/nameasm/turing-sample.asm // Assembly code for turing-samples.nc turing-machine.nc
  ...
  src/namec/Changes.txt // Change history for Namec
